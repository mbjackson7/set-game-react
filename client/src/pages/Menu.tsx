    ...
    <div className="w-screen h-[calc(100dvh)] flex flex-col justify-center items-center gap-10">
      {!nameEntered ? (
        ...
        <>
          ...
          <button
            className="w-40 border-2 bg-purple-600 p-5"
        ...
        <>
          <button
            className="border-2 bg-red-600  p-1"
          ...
          <input
            type="text"
            className="border-2 border-black h-20 w-40 text-5xl text-center"
            placeholder="####"
            value={roomCode}
          ...
          <button
            className="w-40 border-2 bg-green-600 p-5"
            onClick={() => navigate(`/game/${roomCode}/user/${name}`)}
          >
            Enter Room
          </button>
        </>
